...
public record ClientIdPacketIdOffsetCacheKey(String clientId, String cachePrefix) implements Serializable {
    ...
    public String toString() {
        String keyBase = "{" + clientId + "}_packet_id_offset";
        return StringUtils.isBlank(cachePrefix) ? keyBase : cachePrefix + keyBase;
    }

    private static ClientIdPacketIdOffsetCacheKey newInstance(String clientId, String cachePrefix) {
        return new ClientIdPacketIdOffsetCacheKey(clientId, cachePrefix);
    }
