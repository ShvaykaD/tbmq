...
import org.thingsboard.mqtt.broker.gen.queue.MqttClientAuthProviderEvent;
...
public class ProtoConverter {
    ...
    public static InternodeNotificationProto toMqttAuthProviderCreatedEvent(MqttClientAuthProviderDto provider) {
        var mqttAuthProviderProto =
                toCreatedOrUpdatedMqttAuthProviderProto(provider, MqttClientAuthProviderEvent.PROVIDER_CREATED);
    ...
    public static InternodeNotificationProto toMqttAuthProviderUpdatedEvent(MqttClientAuthProviderDto provider) {
        var mqttAuthProviderProto =
                toCreatedOrUpdatedMqttAuthProviderProto(provider, MqttClientAuthProviderEvent.PROVIDER_UPDATED);
        return wrapMqttAuthProviderProtoToInterNodeNotification(mqttAuthProviderProto);
    }
    ...
    public static InternodeNotificationProto toMqttAuthProviderEnabledEvent(UUID id) {
        MqttAuthProviderProto mqttAuthProviderProto =
                toStateChangedMqttAuthProviderProto(id, MqttClientAuthProviderEvent.PROVIDER_ENABLED);
        return wrapMqttAuthProviderProtoToInterNodeNotification(mqttAuthProviderProto);
    }

    public static InternodeNotificationProto toMqttAuthProviderDisabledEvent(UUID id) {
        MqttAuthProviderProto mqttAuthProviderProto =
                toStateChangedMqttAuthProviderProto(id, MqttClientAuthProviderEvent.PROVIDER_DISABLED);
        return wrapMqttAuthProviderProtoToInterNodeNotification(mqttAuthProviderProto);
    }
    ...
    public static InternodeNotificationProto toMqttAuthProviderDeletedEvent(UUID id) {
        MqttAuthProviderProto mqttAuthProviderProto = MqttAuthProviderProto.newBuilder()
                .setEventType(MqttClientAuthProviderEvent.PROVIDER_DELETED)
    ...
    private static MqttAuthProviderProto toCreatedOrUpdatedMqttAuthProviderProto(MqttClientAuthProviderDto provider, MqttClientAuthProviderEvent event) {
        return MqttAuthProviderProto.newBuilder()
                ...
                // TODO: Why convert to string instead of bytes? Consider about this in the Update event as well?
                .setConfiguration(JacksonUtil.toString(provider.getConfiguration()))
                .build();
    }

    private static MqttAuthProviderProto toStateChangedMqttAuthProviderProto(UUID id, MqttClientAuthProviderEvent event) {
        return MqttAuthProviderProto.newBuilder()
                .setEventType(event)
                .setMqttClientAuthProviderIdMSB(id.getMostSignificantBits())
                .setMqttClientAuthProviderIdLSB(id.getLeastSignificantBits())
                .setEnabled(MqttClientAuthProviderEvent.PROVIDER_ENABLED.equals(event))
                .build();
    }
