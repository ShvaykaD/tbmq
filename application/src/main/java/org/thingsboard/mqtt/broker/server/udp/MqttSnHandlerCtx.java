...
@Component
@Data
public class MqttSnHandlerCtx {

    private final ClientMqttActorManager actorManager;
    private final ClientLogger clientLogger;
    private final RateLimitService rateLimitService;
    private final MqttSnMessageGenerator mqttSnMessageGenerator;
    ...
    @Autowired
    public MqttSnHandlerCtx(ClientMqttActorManager actorManager,
                            ClientLogger clientLogger,
                            RateLimitService rateLimitService,
                            MqttSnMessageGenerator mqttSnMessageGenerator,
        ...
        this.mqttSnMessageGenerator = mqttSnMessageGenerator;
